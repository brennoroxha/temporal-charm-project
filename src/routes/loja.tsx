  ...
  return (
    <div className="loja-page">
      <style>{`
        ...
        .loja-price-row{display:flex;align-items:flex-start;gap:6px;line-height:1;flex-wrap:nowrap;width:100%}
        .loja-price{color:#000;font-weight:600;font-size:22px;line-height:1;margin-top:0;display:flex;align-items:flex-start}
        .loja-price .cents{font-size:0.55em;font-weight:600;margin-left:1px;position:relative;top:2px}
        .loja-discount{color:#fff;background:#00a650;font-size:12px;font-weight:700;padding:2px 4px;border-radius:0;display:inline-block;white-space:nowrap;margin-top:2px}
        .loja-stock{font-size:12px;padding:2px 6px;border-radius:0;width:fit-content;margin-top:0;font-weight:400}
        .loja-stock.low{color:#ff2e2e;background:#ffdcdc;padding-left:6px;font-weight:400}
        .loja-stock.out{color:#fff;background:#ff0000;padding:2px 8px;font-weight:700;text-transform:uppercase;border-radius:0}
        .loja-stock.medium{color:#847900;background:#ffffc7;font-weight:400}
        .loja-stock.high{color:#00a650;background:#e6f6ef;font-weight:400}
                  ...
                  {p.stock !== 0 ? (
                    ...
                    >
                      ...
                      <div className="loja-price-row">
                        <div className="loja-price" style={{ whiteSpace: "nowrap" }}>
                          {p.price.split(',')[0]}
                          <span className="cents">{p.price.split(',')[1] || '00'}</span>
                        </div>
